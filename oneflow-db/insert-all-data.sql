...
-- Make sure you've already created the tables first!
-- ============================================

USE oneflow;

-- ============================================
-- IMPORTANT: Generate Password Hashes First
-- ============================================
-- Run this command to generate real password hashes:
-- node -e "console.log(require('bcryptjs').hashSync('password123', 10))"
-- 
-- Or use the generate-password-hash.js script:
-- cd oneflow-db && node generate-password-hash.js
--
-- Replace the hashes below with the generated ones
...
-- Step 1: Insert Users
-- ============================================
-- NOTE: Replace the password_hash values with real bcrypt hashes!
-- Generate them using: node generate-password-hash.js

INSERT INTO users (first_name, last_name, email, password_hash, role, hourly_rate, created_at, updated_at) VALUES
('Admin', 'User', 'admin@gmail.com', '1234', 'admin', 100.00, NOW(), NOW()),
('John', 'Manager', 'manager@oneflow.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'project_manager', 75.00, NOW(), NOW()),
('Alice', 'Developer', 'alice@oneflow.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'team_member', 50.00, NOW(), NOW()),
('Bob', 'Designer', 'bob@oneflow.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'team_member', 45.00, NOW(), NOW()),
('Carol', 'Accountant', 'carol@oneflow.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'sales_finance', 60.00, NOW(), NOW());
