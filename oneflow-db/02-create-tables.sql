...
CREATE TABLE IF NOT EXISTS timesheets (
  ...
  INDEX idx_date (date),
  CONSTRAINT fk_timesheets_task FOREIGN KEY (task_id)
    REFERENCES tasks(id)
    ON UPDATE CASCADE
    ON DELETE CASCADE,
  CONSTRAINT fk_timesheets_user FOREIGN KEY (user_id)
    REFERENCES users(id)
    ON UPDATE CASCADE
    ON DELETE RESTRICT
) ;
...
CREATE TABLE IF NOT EXISTS sales_orders (
  ...
  CONSTRAINT fk_sales_orders_project FOREIGN KEY (project_id)
    REFERENCES projects(id)
    ON UPDATE CASCADE
    ON DELETE RESTRICT
) ;
...
CREATE TABLE IF NOT EXISTS vendor_bills (
  ...
  INDEX idx_state (state),
  CONSTRAINT fk_vendor_bills_project FOREIGN KEY (project_id)
    REFERENCES projects(id)
    ON UPDATE CASCADE
    ON DELETE RESTRICT,
  CONSTRAINT fk_vendor_bills_po FOREIGN KEY (purchase_order_id)
